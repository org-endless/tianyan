...
public class GameEveDataFileBlueprintItemRespDTransfer implements TianyanMetadataDrivenTransfer {
    ...
    @Override
    public GameEveDataFileBlueprintItemRespDTransfer validate() {
        validateQuantity();
        validateTypeID();
        return this;
    }
