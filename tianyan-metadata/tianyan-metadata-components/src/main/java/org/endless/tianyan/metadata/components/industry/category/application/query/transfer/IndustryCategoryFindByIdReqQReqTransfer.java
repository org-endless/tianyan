...
public class IndustryCategoryFindByIdReqQReqTransfer implements TianyanMetadataQueryReqTransfer {
    ...
    @Override
    public IndustryCategoryFindByIdReqQReqTransfer validate() {
