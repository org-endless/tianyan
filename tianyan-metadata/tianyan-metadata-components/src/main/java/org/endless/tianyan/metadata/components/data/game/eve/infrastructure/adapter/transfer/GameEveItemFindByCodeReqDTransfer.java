...
/**
 * GameEveItemFindByCodeReqDTransfer
 * <p>游戏EVE资源项根据编码查询被动请求传输对象
 * <p>
...
public class GameEveItemFindByCodeReqDTransfer implements TianyanMetadataDrivenTransfer {
    ...
    @Override
    public GameEveItemFindByCodeReqDTransfer validate() {
        validateCode();
        return this;
    }
