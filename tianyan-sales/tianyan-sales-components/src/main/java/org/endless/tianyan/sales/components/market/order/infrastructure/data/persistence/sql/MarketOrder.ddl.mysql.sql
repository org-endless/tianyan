...
CREATE TABLE market_order (
    ...
    item_quantity_total  DECIMAL(20, 5) NOT NULL COMMENT '市场订单资源项总数(20, 5)',
    item_quantity_remain DECIMAL(20, 5) NOT NULL COMMENT '市场订单资源项剩余数量(20, 5)',
    item_quantity_min    DECIMAL(20, 5) NOT NULL COMMENT '市场订单资源项最小交易数量(20, 5)',
    ...
    status               VARCHAR(255)   NOT NULL COMMENT '市场订单状态',
    ...
    CONSTRAINT PRIMARY KEY pk_market_order (market_order_id)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT '市场订单表';
CREATE INDEX idx_market_o_item_id ON market_order (item_id);
CREATE INDEX idx_market_o_item_id_type ON market_order (item_id, type);
