 ...
 *
 * @author Deng Haozhi
 * @see TianyanSalesCommandHandler<MarketPriceHistoryAggregate>
 * @since 0.0.1
 */
public interface MarketPriceHistoryCommandHandler extends TianyanSalesCommandHandler<MarketPriceHistoryAggregate> {
}
