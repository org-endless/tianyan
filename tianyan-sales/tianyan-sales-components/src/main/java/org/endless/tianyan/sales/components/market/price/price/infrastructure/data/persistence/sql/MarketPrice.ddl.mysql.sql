...
CREATE TABLE market_price (
    market_price_id VARCHAR(255)   NOT NULL COMMENT '市场价格ID',
    ...
    CONSTRAINT PRIMARY KEY pk_market_price (market_price_id)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT '市场价格表';
CREATE INDEX idx_market_p_item_id ON market_price (item_id);
