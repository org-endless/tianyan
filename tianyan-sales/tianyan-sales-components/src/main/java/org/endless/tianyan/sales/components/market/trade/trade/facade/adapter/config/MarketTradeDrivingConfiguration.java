package org.endless.tianyan.sales.components.market.trade.trade.facade.adapter.config;

import org.endless.tianyan.sales.components.market.trade.trade.application.command.handler.MarketTradeCommandHandler;
import org.endless.tianyan.sales.components.market.trade.trade.application.command.handler.impl.MarketTradeCommandHandlerImpl;
...
import org.endless.tianyan.sales.components.market.trade.trade.application.query.handler.impl.MarketTradeQueryHandlerImpl;
...
import org.endless.tianyan.sales.components.market.trade.trade.facade.adapter.spring.SpringMarketTradeDrivingAdapter;
