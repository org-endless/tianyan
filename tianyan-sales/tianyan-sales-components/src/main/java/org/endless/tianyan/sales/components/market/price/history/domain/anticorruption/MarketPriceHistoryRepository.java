package org.endless.tianyan.sales.components.market.price.history.domain.anticorruption;
 ...
 * @since 0.0.1
 */
public interface MarketPriceHistoryRepository extends TianyanSalesRepository<MarketPriceHistoryAggregate> {
}
