package org.endless.tianyan.sales.components.market.trade.trade.application.command.handler;
 ...
 *
 * @author Deng Haozhi
 * @see TianyanSalesCommandHandler<MarketTradeAggregate>
 * @since 0.0.1
 */
public interface MarketTradeCommandHandler extends TianyanSalesCommandHandler<MarketTradeAggregate> {
