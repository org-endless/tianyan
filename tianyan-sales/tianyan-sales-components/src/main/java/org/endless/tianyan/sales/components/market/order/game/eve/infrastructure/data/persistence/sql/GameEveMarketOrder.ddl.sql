...
CREATE TABLE market_order_game_eve (
    ...
    range VARCHAR(255) NOT NULL COMMENT '订单范围',
    system_code VARCHAR(255) NOT NULL COMMENT '游戏EVE市场订单星系编码',
    system_name_zh VARCHAR(255) NOT NULL COMMENT '游戏EVE市场订单星系中文名称',
    location_code VARCHAR(255) NOT NULL COMMENT '游戏EVE市场订单空间站编码',
    location_name_zh VARCHAR(255) NOT NULL COMMENT '游戏EVE市场订单空间站中文名称',
