package org.endless.tianyan.finance.common.model.domain.service;
 ...
 * @since 0.0.1
 */
public interface TianyanFinanceService<A extends TianyanFinanceAggregate>
        extends Service<A> {
