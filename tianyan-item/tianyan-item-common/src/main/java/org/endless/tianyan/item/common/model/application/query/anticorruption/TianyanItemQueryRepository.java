package org.endless.tianyan.item.common.model.application.query.anticorruption;
 ...
 * @since 0.0.1
 */
public interface TianyanItemQueryRepository<E extends TianyanItemEntity> extends QueryRepository<E> {
