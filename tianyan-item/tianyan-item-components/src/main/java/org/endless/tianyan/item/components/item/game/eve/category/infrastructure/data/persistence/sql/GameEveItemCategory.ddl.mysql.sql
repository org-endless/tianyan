...
CREATE TABLE item_category_game_eve (
    ...
    CONSTRAINT PRIMARY KEY pk_item_category_game_eve (game_eve_item_category_id),
    CONSTRAINT UNIQUE uk_item_cge_category_id (item_category_id, remove_at),
    CONSTRAINT UNIQUE uk_item_cge_code (code, remove_at)
