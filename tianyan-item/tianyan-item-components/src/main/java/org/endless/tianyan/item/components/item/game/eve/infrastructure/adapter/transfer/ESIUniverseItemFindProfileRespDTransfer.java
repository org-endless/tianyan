...
import org.endless.tianyan.item.common.model.infrastructure.adapter.transfer.*;
...
/**
 * ESIUniverseItemFindProfileRespDTransfer
...
public class ESIUniverseItemFindProfileRespDTransfer implements TianyanItemDrivenTransfer {
    ...
    @Override
    public ESIUniverseItemFindProfileRespDTransfer validate() {
        validateGroup_id();
        validateName();
        validatePublished();
        return this;
