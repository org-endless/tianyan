...
CREATE TABLE item_group_game_eve (
    game_eve_item_group_id    VARCHAR(255) NOT NULL PRIMARY KEY COMMENT '游戏EVE物品分组ID',
    item_group_id             VARCHAR(255) NOT NULL COMMENT '物品分组ID',
    code                      VARCHAR(255) NOT NULL COMMENT '游戏EVE物品分组编码',
    game_eve_item_category_id VARCHAR(255) NOT NULL COMMENT '游戏EVE物品分类ID',
    is_published              BOOLEAN      NOT NULL COMMENT '游戏EVE物品分组是否发布',
    is_use_base_price         BOOLEAN      NOT NULL COMMENT '游戏EVE物品分组是否使用基准价格',
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT '游戏EVE物品分组表';
