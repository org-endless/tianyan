...
/**
 * GameEveItemFindByItemIdReqQReqTransfer
...
public class GameEveItemFindByItemIdReqQReqTransfer implements TianyanItemQueryReqTransfer {
    ...
    @Override
    public GameEveItemFindByItemIdReqQReqTransfer validate() {
        validateItemId();
        return this;
    }
