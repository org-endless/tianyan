...
CREATE TABLE item_group_game_eve (
    game_eve_item_group_id VARCHAR(255) NOT NULL COMMENT '游戏EVE资源项分组ID',
    ...
    CONSTRAINT PRIMARY KEY pk_item_group_game_eve (game_eve_item_group_id),
    CONSTRAINT UNIQUE KEY uk_item_gge_group_id (item_group_id, remove_at),
    CONSTRAINT UNIQUE KEY uk_item_gge_code (code, remove_at)
