...
CREATE TABLE item_game_eve (
    game_eve_item_id VARCHAR(255) NOT NULL PRIMARY KEY COMMENT '游戏EVE物品ID',
    item_id VARCHAR(255) NOT NULL COMMENT '物品ID',
    code VARCHAR(255) NOT NULL COMMENT '游戏EVE物品编码',
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT '游戏EVE物品表';