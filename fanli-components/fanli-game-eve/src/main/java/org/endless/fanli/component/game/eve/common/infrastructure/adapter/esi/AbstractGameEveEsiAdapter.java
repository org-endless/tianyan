...
import org.endless.fanli.component.game.eve.common.domain.model.GameEveAdapter;
 ...
 * @since 0.0.6
 */
public interface AbstractGameEveEsiAdapter<T extends GameEveEntity> extends GameEveAdapter<T> {
